...
<form method="post" >
	...
	<?php include('leftbar.php');?>
		...
		<div id="page-wrapper">
		    ...
		    <div class="col-lg-4">
			<label>Selecione Curso<span id="" style="font-size:11px;color:red">*</span>	</label>
			</div>
			<div class="col-lg-6">
...
<option VALUE="">Selecione</option>
		...
		<div class="form-group">
		<div class="col-lg-4">
		<label>Selecione Disciplinas<span id="" style="font-size:11px;color:red">*</span></label>
		</div>
		<div class="col-lg-6">
 <input class="form-control" name="c-full"  id="c-full" >
	 ...
	 <br><br>								
			...
			<div class="form-group">
		<div class="col-lg-4">
		<label>Turma<span id="" style="font-size:11px;color:red">*</span></label>
		</div>
		<div class="col-lg-6">
	...
	<br><br>		
		...
		<div class="form-group">
		 ...
		 <input type="radio" name="gender" id="female" value="feale"> &nbsp; Feminino &nbsp;
		 <input type="radio" name="gender" id="other" value="other"> &nbsp; Outros &nbsp;
			</div>
			</div>	
	<br><br>		
		     <div class="form-group">
			 <div class="col-lg-2">
			<label>Responsavél<span id="" style="font-size:11px;color:red">*</span>	</label>
        ...
        <option value="70000">70000</option>
			 ...
			 <div class="col-lg-2">
			<label>Serviço<span id="" style="font-size:11px;color:red">*</span></label>
        ...
        <option value="sr">PJ</option>
        <option value="st">Intermitente</option>
		<option value="other">Outros</option>
			...
			<br><br>
		     ...
		     <div class="form-group">
			 <div class="col-lg-2">
			<label>Deficiencia Fisica <id="" style="font-size:11px;color:red">*</span></label>
 ...
 <select name="state" id="state"  class="form-control" onchange="showDist(this.value)" required="required">
	...
	<br><br><br><br>		
        ...
        <option value="">Selecione </option>
			 ...
			 <div class="col-lg-2">
			<label>Endereço<span id="" style="font-size:11px;color:red">*</span></label>
			...
			<br><br>
		     ...
		     <div class="form-group">
			 <div class="col-lg-2">
			<label>Endereço segundario<span id="" style="font-size:11px;color:red">*</span>
                            ...
                            <div class="table-responsive">
                                <table class="table">
                                    <thead>
                                        <tr>
                                         <div class="col-lg-6">
			<th>&nbsp;&nbsp;&nbsp;&nbsp;Cursos Academicos <span id="" style="font-size:11px;color:red">*</span>	</label></th>
			</div>   
            <div class="col-lg-6">
			<th>&nbsp;&nbsp;&nbsp;&nbsp;Instuição</th>
			</div>   
              <div class="col-lg-6">
			 <th>&nbsp;&nbsp;&nbsp;&nbsp;Formação<span id="" style="font-size:11px;color:red">*</span></th>
			</div>                                 
            </tr>
                                    </thead>
                                    <tbody>
