...
<form method="post" >
	<div id="wrapper">
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="panel panel-default">
						<div class="panel-heading">Adicionar Disciplina</div>
							...
							<div class="row">
						 	<div class="col-lg-10">
										...
										<div class="form-group">
											<div class="col-lg-4">
					 <label>Sigla<span id="" style="font-size:11px;color:Red">*</span>	</label>
											</div>
		...
		<div class="form-group">
		<div class="col-lg-4">
		<label>Curso<span id="" style="font-size:11px;color:red">*</span></label>
		</div>
		<div class="col-lg-6">
	...
	<input type="submit" class="btn btn-primary" name="submit" value="Adicionar Disciplinas"></button>
											</div>
