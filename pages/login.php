    ...
    <div class="container">
        <br><br><br><br>
            ...
            <div class="col-md-4 col-md-offset-4">
             ...
             <input class="form-control" placeholder="ID"  id="id"name="id" type="text" autofocus autocomplete="off">
                                </div>
                                <div class="form-group">
                                ...
                                <input type="submit" value="Entrar" name="submit" class="btn btn-lg btn-success btn-block">
                            </fieldset>
                        </form>
                    </div>
                </div>
